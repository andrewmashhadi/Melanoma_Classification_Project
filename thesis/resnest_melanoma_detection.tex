...
\hline
\hline
\makecell{Ensemble \#1 \\ (with Conv. Net)} & 0.580 & 0.781 & 0.798 & 0.765 & 0.782 & 0.105\\
\hline
\makecell{Ensemble \#2 \\ (with ResNeSt-269)} & 0.003 & 0.853 & 0.895 & 0.813 & 0.853 & 0.287\\
\hline  
\end{tabular}
...
\centering
\vspace{0cm}
\subcaptionbox{}{\vspace{0.8cm}\begin{tabular}{| c | c |} 
\hline
& \\
\textbf{Model} & \textbf{ROC-AUC} \\ 
& \\
\hline
& \\
...
\hline
& \\
\makecell{Ensemble \#2 \\ (with ResNeSt-269)} & 0.929\\
& \\
\hline
\end{tabular}}\hspace{1em}
\subcaptionbox{}{\includegraphics[height = 90mm, width=100mm]{imgs/results_roc.png}}
\hspace*{\fill}
\label{fig:roc}
